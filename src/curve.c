...
void public_key_set_data(ec_public_key *public_key) {
    uint8_t test_B[32] = {0x2e, 0xd8, 0x2d, 0xe0, 0x65, 0x0a, 0xa0, 0x45, 0x9f, 0xa2, 0xe1, 0xcc, 0x83, 0xd0, 0x88, 0x5e, 0xf0, 0x06, 0x7f, 0x27, 0x24, 0x84, 0xc9, 0x8b, 0xc5, 0xc2, 0xbd, 0x02, 0xc0, 0x4f, 0x84, 0x14};
    memcpy(public_key->data, test_B, DJB_KEY_LEN);
}


void public_key_set_data_Y(ec_public_key *public_key) {
    uint8_t test_Y[32] = {0x09, 0xbb, 0x90, 0xbc, 0x31, 0xd6, 0xd3, 0x0d, 0x2e, 0xa9, 0xeb, 0xd6, 0x3e, 0xb8, 0x81, 0xb5, 0xed, 0x62, 0x0d, 0xef, 0x6e, 0x18, 0x52, 0x33, 0x57, 0xb9, 0x2a, 0xa3, 0x81, 0xe0, 0x1c, 0x32};
    memcpy(public_key->data, test_Y, DJB_KEY_LEN);
}
...
void public_key_set_data_y(ec_private_key *private_key) {
    uint8_t test_Y[32] = {0x78, 0x00, 0xe3, 0x53, 0xd3, 0xef, 0x91, 0xfb, 0xb3, 0x20, 0xfb, 0xea, 0x48, 0xf4, 0x10, 0x5f, 0x8b, 0x0b, 0x9d, 0xc9, 0xd2, 0x7a, 0x7d, 0x8c, 0x02, 0x1e, 0xcf, 0xc2, 0x53, 0xa5, 0x8c, 0x4b};
    memcpy(private_key->data, test_Y, DJB_KEY_LEN);
}
